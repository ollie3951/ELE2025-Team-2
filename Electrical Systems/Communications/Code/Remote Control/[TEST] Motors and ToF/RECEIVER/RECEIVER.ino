...
void loop()
{
  ...
  {
    rightOutputA = (1023-receiveData[1])/7 + turnAmount; //make speed of motor depend on how far forward joystick is pushed
    rightOutputB= 0;
    leftOutputA = 0;
    leftOutputB = (1023-receiveData[1])/7 - turnAmount; //make speed of motor depend on how far forward joystick is pushed
  ...
  {
    rightOutputA = 0;
    rightOutputB = receiveData[1]/7 + turnAmount; //make speed of motor depend on how far backward joystick is pushed
    leftOutputA = receiveData[1]/7 - turnAmount; //make speed of motor depend on how far backward joystick is pushed
    leftOutputB = 0;
