...
<body>
  ...
  <p>
    ...
    <span id="temperature">%TEMPERATURE%</span>   //%TEMPERATURE% is a placeholder for the read humidity value
    <sup class="units">&deg;C</sup>
  </p>
  <p>
    <i class="fas fa-tint" style="color:#00add6;"></i> 
    <span class="dht-labels">Humidity</span>
    <span id="humidity">%HUMIDITY%</span>   //%HUMIDITY% is a placeholder for the read humidity value
...
setInterval(function ( ) {
  ...
  xhttp.send();
}, 1000 ) ; //time between updates on page (ms)
